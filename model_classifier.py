...
dna_sequences_file = "dataset/seq_100.2_train.txt"
model_path = "./models/1000/"

# encoder_hidden_size_1 = 100
# encoder_hidden_size_2 = 100
encoder_output_size = 1000
...
enc_2_w1 = init_weights((1, max_size_dataset))
enc_2_b1 = tf.Variable(np.zeros((1, encoder_output_size)), dtype=tf.float32)

enc_2_w2 = init_weights((encoder_output_size, 1))
enc_2_b2 = tf.Variable(np.zeros((1, encoder_output_size)), dtype=tf.float32)
